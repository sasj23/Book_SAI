...
public class BookSellerAgent extends Agent{
	...
	protected void takeDown() {
	  ...
	  System.out.println("Agente vendedor " + getAID().getName() + "ha terminado.");
	}
	...
	public void updateCatalogue(final String title, final int price) {
	  addBehaviour(new OneShotBehaviour() {
	    public void action() {
	      ...
	      System.out.println("El libro "+title + " fue registrado por " + getAID().getName() + " con un precio de: " + price);
	    }
	  });
	}
